...
- Lenovo M900 for my [homelab](/blog/2024/10/my-new-homelab/)
...
<figure>
    ...
    <figcaption>This photo is very out of date but it's close enough</figcaption>
</figure>
...
- [Mode SixtyFive](/blog/2024/12/mode-sixtyfive/)
...
- Kokuyo Campus Smart Ring binder notebook and Campus Sarasara B5 loose leaf paper for thinking
- Lamy Safari fountain pen with an extra-fine nib and Diamine "Regency Blue" ink
- Zebra G-750 with 0.5mm Energel refill, Uni-ball Zento Flow
...
- [miniflux](https://miniflux.app/) (self-hosted) for RSS
- [wallabag](https://wallabag.org/) (self-hosted) for read-it-later
